public class LogicGate {
    ...
    public boolean getOutput(){
        switch (gateId) {
            case 0:	return !(one);         // break;  will be unreachable
            case 1: return (one && two);   // break;  will be unreachable
            case 2: return (one || two);   // break;  will be unreachable
            case 3: return (one ^ two);    // break;  will be unreachable
            case 4: return !(one && two);  // break;  will be unreachable
            case 5: return !(one || two);  // break;  will be unreachable
            default:
                break;
        }
        return false;
